...
var fight = function(enemy) {
    while (playerInfo.health > 0 && enemy.health > 0) {
        ...
        console.log(playerInfo.name + " has attacked " + enemy.name + ". " + enemy.name + " now has " + enemy.health + " health points.");
        ...
        playerInfo.health = Math.max(0, playerInfo.health - damage); // 0 = min & (playerInfo.health - damage) = max 
        console.log(
...
var startGame = function() {
    ...
    for(var i = 0; i < enemyInfo.length; i++) {
        ...
        if (playerInfo.health > 0) {
            ...
            if (playerInfo.health > 0 && i < enemyInfo.length - 1) { //since arrays are indexed - 1 always gives us the last item
